        ...
        <table class="w-full border-collapse border border-gray-300">
            ...
            <tbody>
                ...
                @if($notice->notificationType)
                    @if($notice->NotificationType->type == 'announcement') text-orange-600
                    @elseif($notice->NotificationType->type == 'information') text-blue-600
                    @elseif($notice->NotificationType->type == 'outage') text-red-600
                    @else text-gray-600
                @endif
            @endif">
